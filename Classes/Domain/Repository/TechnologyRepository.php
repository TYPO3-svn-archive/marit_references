...
/**
 * A repository for Technologies
 */
class Tx_MaritReferences_Domain_Repository_TechnologyRepository extends Tx_MaritReferences_Domain_Repository_BaseRepository {
