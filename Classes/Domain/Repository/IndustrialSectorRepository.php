...
/**
 * A repository for IndustrialSectors
 */
class Tx_MaritReferences_Domain_Repository_IndustrialSectorRepository extends Tx_MaritReferences_Domain_Repository_BaseRepository {
